...
public class Panel extends LinearLayout {
	...
	public void run() {
	    ...
	    animation = new TranslateAnimation(fromXDelta, toXDelta,
		    fromYDelta, toYDelta);
	    Loge.i("calculatedDuration: " + calculatedDuration);
	    if (calculatedDuration <= mDuration) {
		animation.setDuration(calculatedDuration);
	    } else {
		animation.setDuration(mDuration - 300);
	    }
