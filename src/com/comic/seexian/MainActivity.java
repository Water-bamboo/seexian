...
public class MainActivity extends Activity {
	...
	mWeibo = Weibo
		.getInstance(ConstantsSina.APP_KEY, ConstantsSina.REDIRECT_URL, ConstantsSina.SCOPE);
	...
	sinaAuthButton.setOnClickListener(new View.OnClickListener() {
		...
		if ((sToken == null || sToken.isEmpty()) && (sCode == null || sCode
			.isEmpty())) {
		    mSsoHandler = new SsoHandler(MainActivity.this, mWeibo);
		    mSsoHandler.authorize(new AuthDialogListener(), null);
		} else {
		    if (mProfileDialog == null) {
			mProfileDialog = new ProfileDialog(mCtx, R.style.Theme_dialog);
		    }
		    mProfileDialog.show();
		}
	...
	case Constants.RESULT_ALBUM:
		...
		Bitmap bmp = BitmapUtils
			.getBitmapFromUri(getApplicationContext(), photoUri);
		if (bmp == null) {
		    return;
		}
		...
		if (mPhoto != null) {
			...
			mImageUploadDialog = new ImageUploadDialog(this, R.style.Theme_dialog, mHandler);
		    }
	...
	new Thread(new Runnable() {
		...
		Object oUserId = SeeXianNetUtils.getResult("https://api.weibo.com/2/account/get_uid.json", null, acctoken);
		if (oUserId == null) {
		    return;
		}
		...
		Object oUserInfo = SeeXianNetUtils
			.getResult("https://api.weibo.com/2/users/show.json", params, acctoken);
		...
		if ((userInfo.mScreenName != null && !userInfo.mScreenName
			.isEmpty()) && (userInfo.mAvatar != null && !userInfo.mAvatar
			.isEmpty())) {
	...
	public void onCancel() {
	    Toast.makeText(getApplicationContext(), "Auth cancel", Toast.LENGTH_LONG)
		    .show();
	}
	...
	public void onComplete(Bundle values) {
		...
		AccessTokenKeeper
			.keepAccessToken(getApplicationContext(), MainActivity.accessToken);
	    }
	    ...
	    Toast.makeText(getApplicationContext(), mCtx.getResources()
	...
	public void onError(WeiboDialogError arg0) {
	    Toast.makeText(getApplicationContext(), "Auth error : " + arg0.getMessage(), Toast.LENGTH_LONG)
		    .show();
	}

	@Override
	public void onWeiboException(WeiboException arg0) {
	    Toast.makeText(getApplicationContext(), "Auth exception : " + arg0.getMessage(), Toast.LENGTH_LONG)
		    .show();
	}
	...
	public boolean handleMessage(Message msg) {
		...
		if (mUploadService != null && mBinder != null) {
			...
			try {
			    ...
			    mPhoto.compress(Bitmap.CompressFormat.JPEG, 100, byteStream);
			    ...
			    mBinder.transact(UploadService.CODE_UPLOADE_PHOTO, pdata, null, IBinder.FLAG_ONEWAY);
	...
	protected String doInBackground(Void... params) {
	    ...
	    SharedPreferences pref = mCtx
		    .getSharedPreferences("seexian", Context.MODE_APPEND);
	    ...
	    Object oWeather = SeeXianNetUtils
		    .getResult("http://api.map.baidu.com/telematics/v3/weather", queryParams, null);
	    if (oWeather == null) {
		return null;
	    }
