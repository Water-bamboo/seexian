...
public class PhotoManager {
                    ...
                    if (photoTask.getImageURL() == localURL)
                        ...
                        switch (inputMessage.what) {
                            ...
                            case DOWNLOAD_STARTED:
                                ...
                                localView.setStatusResource(R.drawable.image_downloading);
                                break;
                            ...
                            case DOWNLOAD_FAILED:
                                ...
                                localView.setStatusResource(R.drawable.image_error);
    ...
    static public PhotoTask startDownload(
        ...
        if (null == downloadTask.getByteBuffer()) {
            ...
            imageView.setStatusResource(R.drawable.image_downloading);
